...
namespace BrightstarDB.Mobile.Tests.EntityFramework 
{
    public partial class MyEntityContext : BrightstarEntityContext {
    	...
    	static MyEntityContext() 
    	{
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Mobile.Tests.EntityFramework.INote));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Mobile.Tests.EntityFramework.INote, BrightstarDB.Mobile.Tests.EntityFramework.Note>();
    	}
