...
namespace BrightstarDB.PerformanceTests
{
    public class PerformanceTestBase
    {
        ...
        private static void CreateData(MyEntityContext ctx)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                IDepartment dep = ctx.Departments.Create();
            ...
            IWebsite website1 = ctx.Websites.Create();
            website1.Name = "website1";
            website1.Url = "http://website1.com";

            IWebsite website2 = ctx.Websites.Create();
            ...
            {
                IArticle art = ctx.Articles.Create();
                art.Title = "Article" + i;
