...
namespace BrightstarDB.Client
{
    ...
    internal class DataObject : IDataObject
    {
        ...
        public IDataObject RemovePropertiesOfType(IDataObject type)
        {
            ...
            {
                _store.DeletePatterns.Add(new Triple{Subject = Identity, Predicate = type.Identity, Object = Constants.WildcardUri});
            }
        ...
        {
            CheckLoaded();
            _store.DeletePatterns.Add(new Triple {Predicate = type.Identity, Object = Identity});
        ...
        {
            CheckLoaded();
            Triple triple = _triples.Where(t => t.Predicate.Equals(type.Identity.ToString())).FirstOrDefault();
        ...
        public void Delete()
        {
            ...
            _store.DeletePatterns.Add(new Triple {Subject = Constants.WildcardUri, Predicate = Constants.WildcardUri, Object = Identity});
        ...
        private void SetTriple(Triple triple)
        {
            ...
            IEnumerable<Triple> matchingTriples = _triples.Where(t => t.Predicate.Equals(triple.Predicate));
            if (matchingTriples.Count() > 0)
            {
        ...
        private void RemoveDataObjectProperty(IDataObject type, IDataObject value)
        {
            ...
            if (_triples.RemoveAll(t => t.Predicate.Equals(type.Identity) && t.Object.Equals(value.Identity)) > 0)
            {
                ...
                _store.DeletePatterns.Add(triple);
            }
