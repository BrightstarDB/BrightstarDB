...
namespace BrightstarDB.Tests.EntityFramework
{
    public abstract class OptimisticLockingTestsBase : ClientTestBase
    {
        ...
        protected virtual void TestSimplePropertyRefreshWithClientWins()
        {
            ...
            var alice2 = context2.Persons.Where(p => p.Id.Equals(alice1.Id)).FirstOrDefault();
            ...
            catch (TransactionPreconditionsFailedException)
            {
                ...
                var alice3 = context3.Persons.Where(p => p.Id.Equals(alice1.Id)).FirstOrDefault();
        ...
        public void TestRelatedObjectRefreshWithClientWins()
        {
            ...
            var context2 = NewContext();
            var alice2 = context2.Persons.Where(p => p.Id.Equals(alice1.Id)).FirstOrDefault();
            var webDesign2 = context2.Skills.Where(s => s.Id.Equals(webDesign1.Id)).FirstOrDefault();
        ...
        public void TestObjectCollectionRefreshWithClientWins()
        {
            ...
            catch (TransactionPreconditionsFailedException)
            {
                ...
                Assert.IsTrue(alice3.Skills.Any(s => s.Id.Equals(programming1.Id)), "Could not find Programming skill after save");
                Assert.IsTrue(alice3.Skills.Any(s => s.Id.Equals(scrum1.Id)), "Could not find SCRUM skill after save");
            }
        }
        ...
        public void TestObjectCollectionRefreshWithStoreWins()
        {
            ...
            catch (TransactionPreconditionsFailedException)
            {
                ...
                Assert.AreEqual(2, alice3.Skills.Count);
                Assert.IsTrue(alice3.Skills.Any(s => s.Id.Equals(programming1.Id)), "Could not find Programming skill after save");
                Assert.IsTrue(alice3.Skills.Any(s => s.Id.Equals(projMgt1.Id)), "Could not find Project Management skill after save");
            }
        }
        #endregion
