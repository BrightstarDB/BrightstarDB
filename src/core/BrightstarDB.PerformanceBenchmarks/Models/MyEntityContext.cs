...
namespace BrightstarDB.PerformanceBenchmarks.Models 
{
    public partial class MyEntityContext : BrightstarEntityContext {
    	...
    	internal IEntitySet<BrightstarDB.PerformanceBenchmarks.Models.IFoafPerson> FoafPersons
    	{
    		get; private set;
    	}
...
namespace BrightstarDB.PerformanceBenchmarks.Models 
{
    ...
    internal partial class FoafPerson : BrightstarEntityObject, IFoafPerson 
    {
    	...
    	public System.Collections.Generic.ICollection<BrightstarDB.PerformanceBenchmarks.Models.IFoafPerson> KnownBy
    	{
    		get { return GetRelatedObjects<BrightstarDB.PerformanceBenchmarks.Models.IFoafPerson>("KnownBy"); }
