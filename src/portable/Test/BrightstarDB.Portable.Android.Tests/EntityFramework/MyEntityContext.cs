...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    public partial class MyEntityContext : BrightstarEntityContext {
        ...
        public static void InitializeEntityMappingStore()
        {
    		...
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal, BrightstarDB.Portable.Android.Tests.EntityFramework.Animal>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment, BrightstarDB.Portable.Android.Tests.EntityFramework.Department>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity, BrightstarDB.Portable.Android.Tests.EntityFramework.Entity>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent, BrightstarDB.Portable.Android.Tests.EntityFramework.FoafAgent>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson, BrightstarDB.Portable.Android.Tests.EntityFramework.FoafPerson>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole, BrightstarDB.Portable.Android.Tests.EntityFramework.JobRole>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson, BrightstarDB.Portable.Android.Tests.EntityFramework.Person>();
    		provider.AddMappingsForType(EntityMappingStore.Instance, typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill));
    		EntityMappingStore.Instance.SetImplMapping<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill, BrightstarDB.Portable.Android.Tests.EntityFramework.Skill>();
    	}
    	...
    	{
    		Animals = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal>(this);
    		Departments = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment>(this);
    		Entities = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity>(this);
    		FoafAgents = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent>(this);
    		FoafPersons = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson>(this);
    		JobRoles = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole>(this);
    		Persons = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>(this);
    		Skills = 	new BrightstarEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>(this);
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal> Animals
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment> Departments
    	{
    		get; private set;
    	}
    	
    	internal IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity> Entities
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent> FoafAgents
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson> FoafPersons
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole> JobRoles
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson> Persons
    	{
    		get; private set;
    	}
    	
    	public IEntitySet<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill> Skills
    	{
    		get; private set;
    	}
        ...
        public IEntitySet<T> EntitySet<T>() where T : class {
            ...
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal))) {
                return (IEntitySet<T>)this.Animals;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment))) {
                return (IEntitySet<T>)this.Departments;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity))) {
                return (IEntitySet<T>)this.Entities;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent))) {
                return (IEntitySet<T>)this.FoafAgents;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson))) {
                return (IEntitySet<T>)this.FoafPersons;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole))) {
                return (IEntitySet<T>)this.JobRoles;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson))) {
                return (IEntitySet<T>)this.Persons;
            }
            if (typeof(T).Equals(typeof(BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill))) {
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class Animal : BrightstarEntityObject, IAnimal 
    {
    	...
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal
    	...
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson Owner
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Owner"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Owner", value); }
    	}
    	#endregion
    }
}
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class Department : BrightstarEntityObject, IDepartment 
    {
    	...
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment
    	...
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson> Persons
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Persons"); }
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    internal partial class Entity : BrightstarEntityObject, IEntity 
    {
    	...
    	public Entity() : base() { }
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IEntity
    	...
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.TestEnumeration SomeEnumeration
    	{
            		get { return GetRelatedProperty<BrightstarDB.Portable.Android.Tests.EntityFramework.TestEnumeration>("SomeEnumeration"); }
            		set { SetRelatedProperty("SomeEnumeration", value); }
    	}
    
    	public System.Nullable<BrightstarDB.Portable.Android.Tests.EntityFramework.TestEnumeration> SomeNullableEnumeration
    	{
            		get { return GetRelatedProperty<System.Nullable<BrightstarDB.Portable.Android.Tests.EntityFramework.TestEnumeration>>("SomeNullableEnumeration"); }
            		set { SetRelatedProperty("SomeNullableEnumeration", value); }
    	}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.TestFlagsEnumeration SomeFlagsEnumeration
    	{
            		get { return GetRelatedProperty<BrightstarDB.Portable.Android.Tests.EntityFramework.TestFlagsEnumeration>("SomeFlagsEnumeration"); }
            		set { SetRelatedProperty("SomeFlagsEnumeration", value); }
    	}
    
    	public System.Nullable<BrightstarDB.Portable.Android.Tests.EntityFramework.TestFlagsEnumeration> SomeNullableFlagsEnumeration
    	{
            		get { return GetRelatedProperty<System.Nullable<BrightstarDB.Portable.Android.Tests.EntityFramework.TestFlagsEnumeration>>("SomeNullableFlagsEnumeration"); }
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class FoafAgent : BrightstarEntityObject, IFoafAgent 
    {
    	...
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafAgent
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class FoafPerson : BrightstarEntityObject, IFoafPerson 
    {
    	...
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson
    	...
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson> Knows
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson>("Knows"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Knows", value); }
    								}
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson> KnownBy
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.IFoafPerson>("KnownBy"); }
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class JobRole : BrightstarEntityObject, IJobRole 
    {
    	...
    	public JobRole() : base() { }
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class Person : BrightstarEntityObject, IPerson 
    {
    	...
    	public Person() : base() { }
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson
    	...
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson Mother
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Mother"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Mother", value); }
    	}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson Father
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Father"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Father", value); }
    	}
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson> Friends
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Friends"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Friends", value); }
    								}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal Pet
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal>("Pet"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IAnimal>("Pet", value); }
    	}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill MainSkill
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("MainSkill"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("MainSkill", value); }
    	}
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill> Skills
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("Skills"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Skills", value); }
    								}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment Department
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment>("Department"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IDepartment>("Department", value); }
    	}
    	...
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole JobRole
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole>("JobRole"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IJobRole>("JobRole", value); }
    	}
...
namespace BrightstarDB.Portable.Android.Tests.EntityFramework 
{
    ...
    public partial class Skill : BrightstarEntityObject, ISkill 
    {
    	...
    	public Skill() : base() { }
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
    	#region Implementation of BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill
    	...
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson Expert
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Expert"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("Expert", value); }
    	}
    
    	public BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill Parent
    	{
            get { return GetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("Parent"); }
            set { SetRelatedObject<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("Parent", value); }
    	}
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill> Children
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.ISkill>("Children"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedObjects("Children", value); }
    								}
    	public System.Collections.Generic.ICollection<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson> SkilledPeople
    	{
    		get { return GetRelatedObjects<BrightstarDB.Portable.Android.Tests.EntityFramework.IPerson>("SkilledPeople"); }
