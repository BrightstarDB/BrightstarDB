...
namespace BrightstarDB.Samples.EntityFramework.ChangeTracking 
{
    public partial class MyEntityContext : BrightstarEntityContext {
    	...
    	static MyEntityContext() 
    	{
    		...
    		TypeMappings.SetImplMapping<BrightstarDB.Samples.EntityFramework.ChangeTracking.IArticle, BrightstarDB.Samples.EntityFramework.ChangeTracking.Article>();
    		provider.AddMappingsForType(TypeMappings, typeof(BrightstarDB.Samples.EntityFramework.ChangeTracking.ITrackable));
    		TypeMappings.SetImplMapping<BrightstarDB.Samples.EntityFramework.ChangeTracking.ITrackable, BrightstarDB.Samples.EntityFramework.ChangeTracking.Trackable>();
    	}
