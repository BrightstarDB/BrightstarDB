...
namespace BrightstarDB.Samples.EntityFramework.TweetBox 
{
    ...
    {
    	public HashTag(BrightstarEntityContext context, BrightstarDB.Client.IDataObject dataObject) : base(context, dataObject) { }
    	public HashTag() : base() { }
...
namespace BrightstarDB.Samples.EntityFramework.TweetBox 
{
    ...
    {
    	public SocialNetworkAccount(BrightstarEntityContext context, BrightstarDB.Client.IDataObject dataObject) : base(context, dataObject) { }
...
namespace BrightstarDB.Samples.EntityFramework.TweetBox 
{
    ...
    {
    	public Tweet(BrightstarEntityContext context, BrightstarDB.Client.IDataObject dataObject) : base(context, dataObject) { }
    	public Tweet() : base() { }
    	public System.String Id { get {return GetKey(); } set { SetKey(value); } }
